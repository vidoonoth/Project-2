<x-app-layout>
    ...
    <main class="pt-5 pl-6 pr-6 w-full">
        ...
        <div class="flex flex-col justify-center items-center gap-3 mb-[40px]">
            ...
            <p class="text-center">atau bisa klik & salin link, kemudian buka pada browser <br><a class="font-semibold" href="https://maps.app.goo.gl/xuJhc7pMpFYmMfSH7">https://maps.app.goo.gl/xuJhc7pMpFYmMfSH7</a></p>
        </div>
    </main>
</x-app-layout>
