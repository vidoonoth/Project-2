<x-app-layout>
    <x-slot name="header">
        ...
        <main class="mx auto flex flex-col content-center justify-center items-center justify-content-center place-self-center">
            <div class="w-2/3 mt-11 mb-[200px]">
                <h1 class="border-b border-slate-950 w-fit mb-6 font-semibold">{{ $sejarah->title }}</h1>
                <p class="text-left md:text-justify lg:text-justify xl:text-justify indent-6">{{ $sejarah->content }}</p>
